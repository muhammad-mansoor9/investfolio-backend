...
use App\Http\Controllers\API\PerformanceTestController;
...
Route::get('/stock-signals', [StocksMomentumController::class, 'getStockSignals']);
Route::get('/stock-signals/debug', [StocksMomentumController::class, 'debugSignals']);
