...
class Holding extends PgsqlModel
{
    use HasFactory;
    use HasMarketData;
    use HasUuid;
    ...
    {
        return $this->hasManyThrough(Transaction::class, BasePortfolio::class, 'id', 'portfolio_id', 'portfolio_id', 'id')->orderBy('date', 'DESC');
    }
    ...
    // Remove the scopeWithoutWatchlists method since the watchlist column no longer exists
